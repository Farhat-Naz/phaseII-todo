    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-50 via-white to-gray-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center mb-16">
          <h2 className="text-5xl md:text-6xl font-bold text-gray-900 dark:text-white mb-6 animate-fade-in">
            Organize Your Life
            <br />
          ...
          <p className="text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto mb-8 animate-slide-up">
            A modern, intelligent todo application with voice input support,
            multilingual features, and a beautiful interface.
          </p>
        ...
        <div className="grid md:grid-cols-3 gap-8 mt-20">
          <Card variant="elevated" padding="lg" hover>
            <div className="text-center">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Create, organize, and complete tasks with a beautiful, intuitive interface
              </p>
            </div>
          </Card>
          ...
          <Card variant="elevated" padding="lg" hover>
            <div className="text-center">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Add and manage tasks using natural voice commands in multiple languages
              </p>
            </div>
          </Card>
          ...
          <Card variant="elevated" padding="lg" hover>
            <div className="text-center">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Full support for English and Urdu with proper RTL text handling
              </p>
            </div>
          </Card>
        </div>
